...
config :base_project, BaseProjectWeb.Endpoint,
  ...
  render_errors: [view: BaseProjectWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: BaseProject.PubSub,
...
config :base_project, BaseProject.Guardian,
