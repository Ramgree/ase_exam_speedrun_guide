...
config :first_exam, FirstExamWeb.Endpoint,
  ...
  render_errors: [view: FirstExamWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: FirstExam.PubSub,
...
config :first_exam, FirstExam.Guardian,
